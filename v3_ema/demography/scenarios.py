...
def workforce_sensitivity_scenarios(constants: PopGrowthConstants) -> dict[str, list[Scenario]]:
    ...
    return {
        ...
        "healthcare": [
            ...
            Scenario("Public health", mortality_mult=-0.05, pollution_health_reduction_mult=-0.15, target_workforce_ratio=base + 0.25),
        ...
        "healthcare_pollution": [
            ...
            Scenario("Public health + pollution 50%", mortality_mult=-0.05, pollution_impact=0.50, pollution_health_reduction_mult=-0.15, target_workforce_ratio=base + 0.25),
        ...
        "sol": [
            Scenario("SoL 7", projection_sol=7.0, target_workforce_ratio=base + 0.25),
            Scenario("SoL 8", projection_sol=8.0, target_workforce_ratio=base + 0.25),
            Scenario("SoL 9", projection_sol=9.0, target_workforce_ratio=base + 0.25),
            Scenario("SoL 10", projection_sol=10.0, target_workforce_ratio=base + 0.25),
            Scenario("SoL 11", projection_sol=11.0, target_workforce_ratio=base + 0.25),
            Scenario("SoL 12", projection_sol=12.0, target_workforce_ratio=base + 0.25),
            Scenario("SoL 13", projection_sol=13.0, target_workforce_ratio=base + 0.25),
